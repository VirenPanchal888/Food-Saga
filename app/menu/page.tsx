                  ...
                  <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 mb-4">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        {item.featured && (
                          <span className="bg-white bg-opacity-20 text-white px-3 py-1 text-xs font-medium tracking-wider">
                            FEATURED
                          </span>
                        )}
                      </div>
      ...
      <footer className="bg-black text-white py-8 border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm tracking-wide">© 2025 AMAI Café</p>
            <div className="flex space-x-6 mt-4 md:mt-0">
              <a href="#" className="text-white hover:opacity-60 transition-opacity duration-200">
                Instagram
              </a>
              <a href="#" className="text-white hover:opacity-60 transition-opacity duration-200">
                Facebook

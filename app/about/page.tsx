          ...
          <div className="relative w-full h-full">
            ...
            <div className="absolute inset-0 bg-gradient-to-b from-black/30 via-transparent to-black/50 flex items-center justify-center z-10">
              <div className="text-center text-white max-w-4xl px-4">
                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-normal tracking-wider mb-4 md:mb-8 text-white drop-shadow-lg">
                  ABOUT
                </h1>
          ...
          <div className="space-y-16 sm:space-y-20 md:space-y-24">
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-16 items-center">
              <div className="space-y-6">
                <h3 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-medium leading-relaxed text-gray-200">Our Story</h3>
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-16 items-center">
              ...
              <div className="order-1 lg:order-2 space-y-6">
                <h3 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-medium leading-relaxed text-gray-200">Our Values</h3>
                <p className="text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed text-gray-200 text-left">
            ...
            <div className="text-center max-w-4xl mx-auto">
              <h3 className="text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed text-gray-200 mb-4 sm:mb-6 md:mb-8">
          ...
          <div className="text-center space-y-6 sm:space-y-8">
            ...
            <div className="flex justify-center">
              <img
                ...
                className="h-8 sm:h-10 md:h-12 w-auto hover:opacity-80 transition-opacity duration-200"
                onError={(e) => {
            ...
            <div className="flex justify-center">
              <a
                href="https://instagram.com/amai_experience"
                target="_blank"
                rel="noopener noreferrer"
                className="text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed text-gray-200 hover:text-white transition-colors duration-200"
              >
                @amai_experience
              </a>
            </div>
